        ...
        <>
            <header>
                <div className="navbar">
                    ...
                    {/* hamburger */}
                    <svg className={ hide ? "null" : "d-none" } xmlns="http://www.w3.org/2000/svg" width="24" height="11" onClick={handleHamburgerButton}>
                        <g fill="#2D314D" fillRule="evenodd">
                            <path d="M0 0h24v1H0zM0 5h24v1H0zM0 10h24v1H0z" />
                        </g>
                    </svg>
                    {/* close button */}
                    <svg className={ hide ? "d-none" : null } xmlns="http://www.w3.org/2000/svg" width="18" height="19" onClick={handleCloseButton}>
                        <g fill="#2D314D" fillRule="evenodd">
